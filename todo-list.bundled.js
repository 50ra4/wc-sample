 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var et;null===(et=window.HTMLSlotElement)||void 0===et||et.prototype.assignedElements;const st=o(['"Hiragino Kaku Gothic ProN"','"Hiragino Sans"','"Helvetica Neue"',"Arial","Meiryo","sans-serif"].join(",")),ot="#fafafa",nt={default:{font:"#212121",background:"#e8eaed"},primary:{font:ot,background:"#212121"},secondary:{font:ot,background:"#2e7c31"},disabled:{font:ot,background:"#62727b"}},rt=[n`
  html,
  body,
  div,
  span,
...
`};
  ...
  `];var lt,ht=function(t,i,e,s){for(var o,n=arguments.length,r=n<3?i:null===s?s=Object.getOwnPropertyDescriptor(i,e):s,l=t.length-1;l>=0;l--)(o=t[l])&&(r=(n<3?o(r):n>3?o(i,e,r):o(i,e))||r);return n>3&&r&&Object.defineProperty(i,e,r),r};let at=class extends Q{constructor(){super(...arguments),this.storageKey="",this.heading="",this.todoList=[],this.hideCompleted=!1,this.text=""}connectedCallback(){var t;if(super.connectedCallback(),!this.storageKey)throw Error("storageKey property is required.");this.todoList=JSON.parse(null!==(t=window.localStorage.getItem(this.storageKey))&&void 0!==t?t:"[]")}disconnectedCallback(){super.disconnectedCallback()}render(){const t=this.hideCompleted?this.todoList.filter((({completed:t})=>!t)):this.todoList;return N`<section>
    ...
    </section>`}toggleHideCompleted(t){this.hideCompleted=t.target.checked}changeText(t){this.text=t.target.value}createTodo(){this.todoList=[...this.todoList,{id:""+(new Date).getTime()*Math.random(),text:this.text,completed:!1,createdAt:(new Date).getTime()}],this.text=""}toggleTodo(t){this.todoList=this.todoList.map((i=>i.id!==t?i:{...i,completed:!i.completed}))}saveTodoList(){if(!this.storageKey)throw Error("storageKey property is required.");window.localStorage.setItem(this.storageKey,JSON.stringify(this.todoList)),window.alert("completed to save.")}clearTodoList(){this.todoList=[]}};at.styles=[...rt,n`
      :host {
        display: block;
    ...
    `],ht([tt({type:String})],at.prototype,"storageKey",void 0),ht([tt({type:String,attribute:"title"})],at.prototype,"heading",void 0),ht([it()],at.prototype,"todoList",void 0),ht([it()],at.prototype,"hideCompleted",void 0),ht([it()],at.prototype,"text",void 0),at=ht([(t=>i=>"function"==typeof i?((t,i)=>(window.customElements.define(t,i),i))(t,i):((t,i)=>{const{kind:e,elements:s}=i;return{kind:e,elements:s,finisher(i){window.customElements.define(t,i)}}})(t,i))("todo-list")],at);export{at as TodoList};
